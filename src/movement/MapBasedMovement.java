...
public class MapBasedMovement extends MovementModel implements SwitchableMovement {
	...
	/** disable WKT map mirroring -setting id ({@value})*/
	public static final String DISABLE_MIRRORING_S = "disableMirroring";
	...
	private SimMap readMap() {
		...
		if (!settings.getBoolean(DISABLE_MIRRORING_S, false)) {
