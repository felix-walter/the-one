...
public abstract class ActiveRouter extends MessageRouter {
	...
	protected int checkReceiving(Message m, DTNHost from) {
		// NOTE: A check for "is transferring" is unnecessary and redundant here!
		// When adding a message to a connection, it is already checked (in startTransfer above)
		// whether this connection is transferring. The check here would also prevent bidirectional connections.
